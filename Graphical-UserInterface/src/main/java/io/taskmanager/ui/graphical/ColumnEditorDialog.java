...
public class ColumnEditorDialog extends Dialog<Column> {
    ...
    public ColumnEditorDialog(TaskRepository repository, Column column) throws IOException, ExecutionException, InterruptedException {
    ...
    public ColumnEditorDialog(TaskRepository repository) throws IOException, ExecutionException, InterruptedException {
